...
if not TAICHI_AVAILABLE:
    class GPUProcessor(MediaProcessor):
        """Fallback dummy class for GPUProcessor when Taichi is not available. Raises ImportError on instantiation to alert users.
        This design choice ensures that the API remains consistent and prevents silent failures or unexpected behavior in environments where Taichi is not installed."""
